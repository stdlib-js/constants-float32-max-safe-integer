...
```javascript
import FLOAT32_MAX_SAFE_INTEGER from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-max-safe-integer@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-max-safe-integer/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-float32-max-safe-integer/actions/workflows/test.yml?query=branch:v0.2.3
